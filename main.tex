...
\defbeamertemplate{footline}{custom}{%
  ...
  \begin{beamercolorbox}[
    ...
    % LEFT: AUTHOR
    \begin{minipage}[c][0.26cm][c]{0.29\paperwidth}%
      \raggedright
      \scriptsize
      \color{white}
      \insertshortauthor
    ...
    % CENTER: TOPIC
    \begin{minipage}[c][0.26cm][c]{0.40\paperwidth}%
      \centering
      \scriptsize
      \color{white}
      \textbf{Industrial Maintenance}
    \end{minipage}%
    
    % RIGHT: SLIDE NUMBER
    \begin{minipage}[c][0.26cm][c]{0.20\paperwidth}%
      \raggedleft
      \scriptsize
      \color{white}
      \insertframenumber
